    ...
    render() {
        return (
            <div className="Professional">
                ...
                <ImageBox topic="Vistaprint: Summer 2018" caption="After my freshmen year of university, I worked at Vistaprint in Waltham, MA as a software engineering intern. 
                    I worked on the Hatchery team to create a Facebook messenger bot that customers can use to build customizable phone cases. " imgurl="professional/vistaprint.png"></ImageBox>
